...
set xlabel "Checksum Iterations" offset 1
...
# set key default
# set key autotitle columnhead
set key autotitle columnhead font ",10" #outside font ",8"
